...
export const About = () => {
  ...
  const backendSkills = ["Node.js", "Python", "SQL", "Shell scripting"];
  const dataSkills = ["Pandas", "Seaborn", "Scikit-learn"];
        ...
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="glass rounded-xl p-8 border-white/10 border hover:-translate-y-1 transition-all">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {/* Statistics/Analysis skills section */}
              <div className="rounded-xl p-6 hover:-translate-y-1 transition-all">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
            ...
            <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
              ...
              <div className="space-y-4 text-gray-300">
                ...
                <div>
                  <h4 className="font-semibold">
                    Intern at DF Startups (2019)
                  </h4>
                  <p>
                    Assisted in building frontend components and itegrating REST
                    APIs.
                  </p>
                </div>
              </div>
